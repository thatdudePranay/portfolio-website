...
export default function Extracurriculars() {
  ...
  return (
    <section id="experiences" className="relative md:sticky md:top-0 bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 min-h-screen" style={{zIndex: 50}}>
      {/* Header */}
